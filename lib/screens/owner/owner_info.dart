...
class OwnerInfo extends StatefulWidget {
  ...
  final int idGetter;
  OwnerInfo({Key key,@required this.idGetter}): super(key: key);
  @override
...
//        password: 'Admin@123#'));
    ...
    var result2= await conn.query(
        'SELECT company_name, company_registration_number, address_number, address_area, city, state, pincode, office_contact_number, office_email FROM owner_company where company_lid=$companyId');
